...
class Opusvier2783Test extends TestCasePublish {

    public function testHandlingOfDefaultFields() {
        $this->switchToGerman();
        ...
        $this->assertTextPresent('Foobar Universitätsbibliothek');
        $this->assertTextPresent('Lizenz');
        $this->assertTextPresent('Creative Commons - Namensnennung-Nicht kommerziell-Keine Bearbeitung');
