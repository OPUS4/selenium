...
class ValidEnrichmentKeyTest extends TestCase {

    public function testValidEnrichmentKeyWithDifferentValues() {
        $this->switchToGerman();
        $this->open("/publish");
        $this->click("//li[@id='primary-nav-publish']/a/em/span");
        $this->waitForPageToLoad("30000");

        $this->select("id=documentType", "label=Demo (enthält nur zwei Felder)");
