...
class FilebrowserTest extends TestCase {
    ...
    /**
     * Wenn von der Import Seite zurück zum Filemanager gegangen wird sollen Änderungen im Formular wieder hergestellt
     * werden.
     */
    public function testKeepChangesWhenImportCancel() {
        ...
        $this->clickAndWait('FileManager-Files-Import');

        $this->assertElementContainsText('headline', 'Add files to document with id 91');
        ...
        $this->assertElementValueEquals('FileManager-Files-File0-Comment', 'Testkommentar');
        $this->assertElementPresent('FileManager-Files-File0-Remove');
