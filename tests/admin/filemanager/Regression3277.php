 ...
 */
class Regression3277 {

    public function testNoUploadFile() {
        $this->switchToEnglish();
        $this->login();

        $this->openAndWait('/admin/filemanager/upload/id/124');

        $this->assertElementContainsText('//a[@href="/opus4dev/admin/document/index/id/124"', 'No title specified for document ID (id = ... (124)');
